...
{
    const string playFromFirstMenuStr = "Tools/ShinnDev/Edit/Always Start From Scene 0 &0";
    ...
    static void LoadFirstSceneAtGameBegins()
    {
        ...
        // LoadScene in Single mode already unloads the current scene, so there is no
        // need to walk and deactivate every object first.
