...
/// - An address string for the device on the board you甏e dealing with.
...
/// corresponding structures are used ?UsbPacket and UdpPacket.  Once you癉e created 
/// a packet, you can simply call its Send() method, with the OscMessage you獮 like to send.  
...
/// send an OscMessage with the address of the device you獮 like to read, but omit 
